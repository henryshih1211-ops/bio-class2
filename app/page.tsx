...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <PwaInstaller />
    <div className="workspace"><section className="schedule panel"><div className="section-heading"><div><CalendarDays size={20}/><h2>本周课表</h2></div><button className="text-button" onClick={()=>setWeek(currentWeek())}>回到本周</button></div>
